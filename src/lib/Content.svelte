...
<div class="content-container">
  ...
  {:else if page === 2}
    <div class="content-wrapper">
      ...
      <div class="history">
        <h2 class="sub-title">1994: THE BEGINNING OF HERL’S JOURNEY</h2>
  ...
  {:else if page === 3}
    <h2 class="sub-title">1996</h2>
    <div class="grid-container">
      <div class="milestone-5">
        <p>
